...
sudo apt install -y vim build-essential conky-all linux-headers-$(uname -r) python-is-python3 python3-tk mangohud ubuntu-restricted-extras vlc ffmpegthumbnailer gnome-tweaks gnome-shell-extension-manager chrome-gnome-shell gstreamer1.0-libav gparted qdirstat python3.10-venv deluge gnome-screenshot pavucontrol blueman wakeonlan
